const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Dashboard-DCustgnW.js","assets/textarea-D5l05Cbi.js","assets/useBackend-BkDdvppL.js","assets/NewSprintModal-DQJQgR-0.js","assets/plus-BVEfGIu5.js","assets/DeptTag-3UswnkA0.js","assets/Onboarding-BDLwav8e.js","assets/link-2-BpJluLOK.js","assets/Milestones-BV_bbTgT.js","assets/Team-Clc0ju6E.js"])))=>i.map(i=>d[i]);
...
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./Dashboard-DCustgnW.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0));
const OnboardingPage = reactExports.lazy(() => __vitePreload(() => import("./Onboarding-BDLwav8e.js"), true ? __vite__mapDeps([6,1,4,7]) : void 0));
const MilestonesPage = reactExports.lazy(() => __vitePreload(() => import("./Milestones-BV_bbTgT.js"), true ? __vite__mapDeps([8,2,1,3,4,7]) : void 0));
const TeamPage = reactExports.lazy(() => __vitePreload(() => import("./Team-Clc0ju6E.js"), true ? __vite__mapDeps([9,2,1,5]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-6 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-64" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-40" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 mt-6", children: ["a", "b", "c"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 rounded-xl" }, k)) })
  ] });
}
...
const onboardingRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/onboarding",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(OnboardingPage, {}) })
});
const milestonesRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/milestones",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MilestonesPage, {}) })
});
